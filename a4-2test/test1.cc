...
const char *dbfile_dir = "/home/deepak/Desktop/dbi/tpch-dbgen/1GB/bin/"; // dir where binary heap files should be stored
const char *tpch_dir ="/home/deepak/Desktop/dbi/tpch-dbgen/1GB/"; // dir where dbgen tpch files (extension *.tbl) can be found
